  ...
  <tbody>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipTitreOn(this, event, 'Champ obligatoire', 'Nom du collaborateur.')" onmouseout="tooltipOff(this, event)">Nom *</a>
      </td>
      <td class="caseInvisible"><input class="niveau2" type="text" name="mNom"></td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipOn(this, event, 'Prénom du collaborateur.')" onmouseout="tooltipOff(this, event)">Prenom</a>
      </td>
      <td class="caseInvisible"><input class="niveau2" type="text" name="mPrenom"></td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipTitreOn(this, event, 'Champ obligatoire', 'Nom que le collaborateur utilisera pour se connecter. Ce login doit être unique.')" onmouseout="tooltipOff(this, event)">Login *</a>
      </td>
      <td class="caseInvisible"><input class="niveau2" type="text" name="mLogin"></td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipTitreOn(this, event, 'Champ obligatoire', 'Adresse mail du collaborateur. Cette adresse sera utilisée par <b>OWEP</b> pour transmettre des messages.')" onmouseout="tooltipOff(this, event)">E-Mail *</a>
      </td>
      <td class="caseInvisible"><input class="niveau2" type="text" name="mMail"</td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipOn(this, event, 'Domicile du collaborateur.')" onmouseout="tooltipOff(this, event)">Adresse</a>
      </td>
      <td class="caseInvisible"><textarea class="niveau2" name="mAdresse" rows=3></textarea></td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipOn(this, event, 'Numéro de téléphone fixe du collaborateur.')" onmouseout="tooltipOff(this, event)">Telephone</a>
      </td>
      <td class="caseInvisible"><input class="niveau2" type="text" name="mTelephone"</td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipOn(this, event, 'Numéro de portable du collaborateur.')" onmouseout="tooltipOff(this, event)">Portable</a>
      </td>
      <td class="caseInvisible"><input class="niveau2" type="text" name="mPortable"</td>
    </tr>
    <tr>
      <td class="caseInvisible">
        <a href="#" onmouseover="tooltipOn(this, event, 'Commentaires et précisions sur le collaborateur. Ces informations ne sont visibles que par les chefs de projets.')" onmouseout="tooltipOff(this, event)">Commentaire</a>
      </td>
