  ...
  public void initialiserParametres () throws ServletException
  {
    ...
    try
    {
      ...
      if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITAJOUTER))
      {
        ...
        mMessage = bundle.getString("clTache")+ " " + lTache.getNom () + " " + bundle.getString("cBienCreee");
      }
        ...
        (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITSUPPRIMER_ARTSORTIES)))
      {
        ...
        mMessage = bundle.getString("clTache")+ " " + lTache.getNom () + " " + bundle.getString("cBienModifiee");
      }
      ...
      else if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITSUPPRIMER))
      {
	    ...
	    for (int i = lTache.getNbConditions() - 1; i >= 0; i--)
	    {
	      ...
	      lRequete = getBaseDonnees ().getOQLQuery ("select CONDITION from owep.modele.execution.MCondition CONDITION where mId = $1") ;
	    ...
	    mMessage = bundle.getString("clTache")+ " " + lTache.getNom () + " " + bundle.getString("cBienSupprimee");
      }
      ...
      if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITAJOUTER_TACDEPEND)) 
      {
        ...
        mMessage = bundle.getString("cDependance")+ " " + lTache.getNom () + " - " + lTachePre.getNom() + " "+ bundle.getString("cBienCreee");
      }
      ...
      else if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITSUPPRIMER_TACDEPEND))
      {
        ...
        mMessage = bundle.getString("cDependance")+ " " + lTache.getNom () + " - " + lCondition.getTachePrecedente ().getNom () + " "+ bundle.getString("cBienSupprimee");
      }
      ...
      if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITAJOUTER_ARTSORTIES))
      {
        ...
        mMessage = bundle.getString("clArtefact")+ " " + lArtefactSortie.getNom () + " "+ bundle.getString("cBienCree");
      }
      ...
      else if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITMODIFIER_ARTSORTIES))
      {
        ...
        mMessage = bundle.getString("clArtefact")+ " " + lArtefactSortie.getNom () + " "+ bundle.getString("cBienModifie");
      }
      ...
      else if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITSUPPRIMER_ARTSORTIES))
      {
        ...
        int lIndiceTache     = Integer.parseInt (getRequete ().getParameter (CConstante.PAR_LISTETACHES)) ;
        int lIndiceArtSortie = Integer.parseInt (getRequete ().getParameter (CConstante.PAR_LISTEARTEFACTSSORTIES)) ;
        int lIdArtSortie = mIteration.getTache (lIndiceTache).getArtefactSortie (lIndiceArtSortie).getId ();
        ...
        mMessage = bundle.getString("clArtefact")+ " " + lArtefactSortie.getNom () + " "+ bundle.getString("cBienSupprime");
      }
      ...
      else if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITAJOUTER_ARTENTREES))
      {
        ...
        mMessage = bundle.getString("clArtefact")+ " " + lArtEntree.getNom () + " "+ bundle.getString("cBienAjoute");
      }
      ...
      else if (VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_SUBMITSUPPRIMER_ARTENTREES)) 
      {
        ...
        mMessage = bundle.getString("clArtefact")+ " " + lArtEntree.getNom () + " "+ bundle.getString("cBienRetire");
   ...
   // Ferme la connexion à la base de données.    
    ...
    else
    {
      if ((VTransfert.getValeurTransmise (getRequete (), CConstante.PAR_VIDE)) &&
        (getRequete ().getParameter (CConstante.PAR_MODIFIER) == null))
      {
        mMessage = bundle.getString("clIteration")+ " " + mIteration.getNumero () + " "+ bundle.getString("cBienCree");
      }
      else
      {
